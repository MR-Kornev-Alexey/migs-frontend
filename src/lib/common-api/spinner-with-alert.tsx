...
interface SpinnerWithAlertProps {
  isMessage?: string; // Optional string
  alertColor?: AlertColor; // Use the defined type
}

const SpinnerWithAlert: React.FC<SpinnerWithAlertProps> = ({ isMessage, alertColor }) => (
  <Box>
...
export default SpinnerWithAlert;
